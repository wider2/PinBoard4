...
class DetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (pinModel == null) {
            ...
            PictureLoader.displayImage(pinModel?.urls?.small.toString(), imageViewPhoto, R.drawable.nocover)
            ...
            imageViewReload.setOnClickListener({ result ->
                ...
                PictureLoader.resumeRequest(pinModel?.urls?.full.toString(), imageViewPhoto, R.drawable.nocover)
            })
            ...
            PictureLoader.displayImage(pinModel?.user?.profile_image?.small.toString(), imageViewAvatar, R.drawable.profile35)
